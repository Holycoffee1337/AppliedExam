...
from shallow_learning import SVM, DT, Boosting, RF, evaluate_all_shallow_models
...
if __name__ == "__main__":
    ...
    # evaluate_all_shallow_models(DataClassSmall)

    ##############################################
    ########### Creating Sweep (RNN) ############# 
    ##############################################

    # sweep_id = wandb.sweep(sweep_config, project='DATA_CLASS')
