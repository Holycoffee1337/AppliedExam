...
pass 
    ...
    def _combine_data(self):
        ...
        for category in self.data_sets:
            ...
            if self.data_sets[category]['val'] is not None:
                val_data = self.data_sets[category]['val']    # val_data = self.data_sets[category]['train']
    ...
    # Load DataHandler (Pickle is faster than json)
    def loadDataHandler(self, class_name):
        self.class_name = class_name
        with open(class_name, 'rb') as input:
