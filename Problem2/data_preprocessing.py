...
class DataHandler:
    ...
    def _mkdir_folder_setup(self):
        ...
        folders = [
            ...
            "./RESULTS/RNN/",
            "./RESULTS/SHALLOW/",
            "./RESULTS/SHALLOW/ENSEMBLE/"
            "./RESULTS/SHALLOW/SAVED_MODELS_SHALLOW/",
            "./RESULTS/SHALLOW/CLASSIFICATION_REPORT/",
            "./RESULTS/SHALLOW/SAVED_SHALLOW_VECTORIZER/",
            "./RESULTS/SHALLOW/CLASSIFICATION_TEST_REPORT/",
    ...
    def _load_test_data(self):
        ...
        full_df = json_to_df(full_df_path)
        full_df = dataFormatting(full_df)
        full_df['overall'] =  full_df['overall'] - 1
...
def split_train_val(df):
    df_X_train, df_X_val = train_test_split(df, test_size=0.5, random_state=42, stratify=df['overall'])
...
def reduce_json_files(max_size_gb=0.0200):
